...
profanity:
	...
	@go run cmd/profanity/main.go --rules PROFANITY_RULES.yml --dirs-exclude="cmd/*" --files-exclude="coverage.html" --dirs-exclude="dist/*" --dirs-exclude="*/node_modules/*" --dirs-exclude="vendor/*"

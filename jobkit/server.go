...
func NewServer(jm *cron.JobManager, cfg Config, options ...web.Option) *web.App {
	...
	app.GET("/pause", func(_ *web.Ctx) web.Result {
		jm.Pause()
		return web.RedirectWithMethod("GET", "/")
	})
	app.GET("/resume", func(_ *web.Ctx) web.Result {
		jm.Resume()
		return web.RedirectWithMethod("GET", "/")
	})
	app.GET("/job/:jobName", func(r *web.Ctx) web.Result {
	...
	app.GET("/job.run/:jobName", func(r *web.Ctx) web.Result {
		jobName, err := r.RouteParam("jobName")
		if err != nil {
			return r.Views.BadRequest(err)
		}
	...
	app.GET("/job.disable/:jobName", func(r *web.Ctx) web.Result {
		jobName, err := r.RouteParam("jobName")
		if err != nil {
			return r.Views.BadRequest(err)
		}
	...
	app.GET("/job.cancel/:jobName", func(r *web.Ctx) web.Result {
		jobName, err := r.RouteParam("jobName")
		if err != nil {
			return r.Views.BadRequest(err)
		}
	...
	app.GET("/api/pause", func(_ *web.Ctx) web.Result {
		jm.Pause()
		return web.JSON.OK()
	})

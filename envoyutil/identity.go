...
type ExtractFromXFCC func(xfcc XFCCElement, xfccValue string) (clientIdentity string, errResponse *XFCCError)
...
type VerifyXFCC func(xfcc XFCCElement, xfccValue string) (errResponse *XFCCError)
